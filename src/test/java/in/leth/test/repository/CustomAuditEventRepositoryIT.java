package in.leth.test.repository;

import in.leth.test.JhipsterApp;
import in.leth.test.config.Constants;
import in.leth.test.config.audit.AuditEventConverter;
import in.leth.test.domain.PersistentAuditEvent;
...
import static in.leth.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
